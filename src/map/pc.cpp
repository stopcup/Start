...
void pc_bonus2(struct map_session_data *sd,int type,int type2,int val)
{
	...
	case SP_SUBELE: // bonus2 bSubEle,e,x;
		...
		if (sd->state.lr_flag != 2) {
			...
			sd->indexed_bonus.subele_script[type2] = cap_value(sd->indexed_bonus.subele_script[type2], 0, 99);
		}
		break;
	case SP_SUBRACE: // bonus2 bSubRace,r,x;
		...
		if (sd->state.lr_flag != 2) {
			...
			sd->indexed_bonus.subrace[type2] = cap_value(sd->indexed_bonus.subrace[type2], 0, 99);
		}
		break;
	case SP_SUBCLASS: // bonus2 bSubClass,c,x;
		...
		if (sd->state.lr_flag != 2) {
			...
			sd->indexed_bonus.subclass[type2] = cap_value(sd->indexed_bonus.subclass[type2], 0, 99);
		}
		break;
	...
	case SP_SUBSIZE: // bonus2 bSubSize,s,x;
		...
		if (sd->state.lr_flag != 2) {
			...
			sd->indexed_bonus.subsize[type2] = cap_value(sd->indexed_bonus.subsize[type2], 0, 99);
		}
		break;
	case SP_MAGIC_SUBSIZE: // bonus2 bMagicSubSize,s,x;
		...
		if (sd->state.lr_flag != 2) {
			...
			sd->indexed_bonus.magic_subsize[type2] = cap_value(sd->indexed_bonus.magic_subsize[type2], 0, 99);
		}
		break;
	case SP_SUBRACE2: // bonus2 bSubRace2,mr,x;
		...
		if (sd->state.lr_flag != 2) {
			...
			sd->indexed_bonus.subrace2[type2] = cap_value(sd->indexed_bonus.subrace2[type2], 0, 99);
		}
		break;
	...
	case SP_SUBDEF_ELE: // bonus2 bSubDefEle,e,x;
		...
		sd->indexed_bonus.subdefele[type2] = cap_value(sd->indexed_bonus.subdefele[type2], 0, 99);
		break;
	...
	case SP_MAGIC_SUBDEF_ELE: // bonus2 bMagicSubDefEle,e,x;
		...
		sd->indexed_bonus.magic_subdefele[type2] = cap_value(sd->indexed_bonus.magic_subdefele[type2], 0, 99);
		break;
	default:
		if (current_equip_combo_pos > 0) {
